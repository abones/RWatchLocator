        ...
        for (potentialSplitLine in lines) {
            ...
            for (currentLine in lines) {
                ...
                if (sideStart == sideEnd)
                    potentialSplit.placeLine(currentLine, sideStart)
                else {
                    ...
                    if (point != null) {
                        ...
                        when {
                            pointAtLineStart -> potentialSplit.placeLine(currentLine, sideEnd)
                            pointAtLineEnd -> potentialSplit.placeLine(currentLine, sideStart)
                            else -> {
                                ...
                                potentialSplit.placeLine(lineStart, sideStart)
                                potentialSplit.placeLine(lineEnd, sideEnd)
                                ++splitCount
                            }
                        }
                    }
